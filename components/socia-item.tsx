...
const contacts = [
      ...
      color: 'hover:bg-[#374151]' },
    {
      ...
      text: 'lalalavard',
      link: 'https://twitter.com/lllavard',
      color: 'hover:bg-[#00acee]'
    },
    {
      icon: 'simple-icons:stackoverflow',
      text: 'lalalavard',
      link: 'https://stackoverflow.com/users/14896070/keqing',
    ...
    },
    {
      ...
      text: 'MurphyChen',
      link: 'https://www.zhihu.com/people/lai-zi-la-fu-de-lu-de-ma-nong',
      color: 'hover:bg-[#056de8]'
    },
    {
      icon: 'ri:bilibili-fill',
      text: 'MurphyChen__',
      link: 'https://space.bilibili.com/40744412',
  ...
  return (
    <ul className="flex flex-wrap list-none mt-5 p-0">
        {contacts.map( ({text,icon,link,color,desc},index) =>  
            ...
            key={index}>
                <a 
                    className={` px-3 py-2 item-bg-color decoration-none flex justify-center items-center rounded-md cursor-pointer title-color hover:text-white ease-linear duration-200 ${color}`}
                    href={link}
                    target="_blank"
